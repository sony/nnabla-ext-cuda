...
export BUILD_EXT_CUDA_DIRECTORY_CPPLIB_MULTI_GPU ?= $(NNABLA_EXT_CUDA_DIRECTORY)/build-multi-gpu$(BUILD_EXT_CUDA_DIRECTORY_CPPLIB_SUFFIX)
DOCKER_RUN_OPTS += -e BUILD_EXT_CUDA_DIRECTORY_CPPLIB_MULTI_GPU=$(BUILD_EXT_CUDA_DIRECTORY_CPPLIB_MULTI_GPU)
...
export BUILD_EXT_CUDA_DIRECTORY_WHEEL_MULTI_GPU ?= $(NNABLA_EXT_CUDA_DIRECTORY)/build_wheel-multi-gpu$(BUILD_EXT_CUDA_DIRECTORY_WHEEL_SUFFIX)
DOCKER_RUN_OPTS += -e BUILD_EXT_CUDA_DIRECTORY_WHEEL_MULTI_GPU=$(BUILD_EXT_CUDA_DIRECTORY_WHEEL_MULTI_GPU)
