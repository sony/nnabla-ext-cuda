...
export NBLA_CUDA_VERSION=$(CUDA_VERSION_MAJOR)$(CUDA_VERSION_MINOR)
export NBLA_CUDNN_VERSION=$(CUDNN_VERSION)

ifndef NNABLA_OPTIONS_INCLUDED
  include $(NNABLA_DIRECTORY)/build-tools/make/options.mk
endif

export NNABLA_EXT_CUDA_VERSION_SUFFIX ?= .cuda$(CUDA_VERSION_MAJOR)$(CUDA_VERSION_MINOR).cudnn$(CUDNN_VERSION)
DOCKER_RUN_OPTS += -e NNABLA_EXT_CUDA_VERSION_SUFFIX=$(NNABLA_EXT_CUDA_VERSION_SUFFIX)
